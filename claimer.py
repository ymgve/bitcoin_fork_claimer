...
class MicroBitcoin(BitcoinFork):
    def __init__(self):
        ...
        self.port = 6403
        self.seeds = ("54.169.196.33", "52.52.107.217", "13.57.248.201", "52.78.59.6", "52.79.198.217", "122.57.100.174", "46.23.35.70", "54.180.14.12", "207.148.28.6", "176.9.102.244", "107.150.60.146", "86.57.193.186", "94.50.162.164", "112.218.69.202", "194.19.235.71", "85.25.133.32", "95.179.163.111", "88.99.192.38", "5.196.66.162", "144.217.73.92", "69.197.128.74", "211.39.150.242", "34.201.170.73", "45.77.149.219", "18.191.69.189", "211.39.150.241", "64.113.174.186", "195.201.212.176", "163.172.11.62", "52.53.141.12", "95.216.33.111", "52.194.177.217", "207.180.248.77")
        self.maketx = self.maketx_basicsig
...
class Bitcoin2(BitcoinFork):
    def __init__(self):
        BitcoinFork.__init__(self)
        self.ticker = "BTC2"
        self.fullname = "Bitcoin 2"
        self.hardforkheight = 507850
        self.magic = 0xf6f0c4e8
        self.port = 8333
        self.seeds = ("seed.bitc2.org", "seeder.bitc2.org")
        self.signtype = 0x01
        self.signid = self.signtype
        self.maketx = self.maketx_basicsig
...
if args.txindex is not None and args.satoshis is not None:
    ...
    if args.cointicker == "BTX":
        ...
        raise Exception("Bitcoin 2 is not a true fork and therefore does not work with blockchain.info mode.")
    else:
